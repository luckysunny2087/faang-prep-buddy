...
Keep answers brief (2-4 sentences). If asked about non-pricing topics, politely redirect to pricing. Use markdown formatting.`;
...
serve(async (req) => {
  ...
  try {
    ...
    console.error("pricing-chat error:", e);
